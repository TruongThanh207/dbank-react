...
contract dBank {
  ...
  function borrow() payable public {
    ...
    uint tokensToMint = collateralEther[msg.sender] *3/ 4;
  ...
  function payOff() public {
    ...
    require(token.transferFrom(msg.sender, address(this), collateralEther[msg.sender]*3/4), "Error, can't receive tokens"); //must approve dBank 1st
